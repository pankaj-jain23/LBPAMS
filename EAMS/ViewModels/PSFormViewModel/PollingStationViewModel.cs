...
{
    public class PollingStationViewModel
    {
        ...
        public List<PollingStationGenderViewModel> PollingStationGenderViewModel { get; set; }
    ...
    public class PollingStationGenderViewModel
    {
        public int? PollingStationMasterId { get; set; }
