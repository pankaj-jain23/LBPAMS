...
{
    public class PollingStationMaster
    {
        [Key]
        ...
        public virtual List<PollingStationGender> PollingStationGender { get; set; }
    ...
    public class PollingStationGender
    {
        [Key]
        public int PollingStationGenderId { get; set; }
        public int PollingStationMasterId { get; set; }
        [ForeignKey("PollingStationMasterId")]
        public virtual PollingStationMaster PollingStationMaster { get; set; }
