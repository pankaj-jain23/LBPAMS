...
namespace EAMS_DAL.Migrations
{
    ...
    [Migration("20240507110303_addedBLOBOothMasterFieldwithrelation")]
    partial class addedBLOBOothMasterFieldwithrelation
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EAMS_ACore.Models.BLOModels.BLOBoothMaster", b =>
                {
                    b.Property<int>("BLOBoothMasterId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");

                    NpgsqlPropertyBuilderExtensions.UseIdentityByDefaultColumn(b.Property<int>("BLOBoothMasterId"));

                    b.Property<string>("BLOBoothCode")
                        .IsRequired()
                        .HasColumnType("text");

                    b.Property<string>("BLOBoothName")
                        .IsRequired()
                        .HasColumnType("text");
                    ...
                    b.Property<string>("PSBuildingName")
                        .IsRequired()
                        .HasColumnType("text");

                    b.HasKey("BLOBoothMasterId");

                    b.HasIndex("BLOMasterId");

                    b.ToTable("BLOBoothMaster");
                });
            ...
            modelBuilder.Entity("EAMS_ACore.Models.Polling_Personal_Randomisation_Models.PPR", b =>
                {
                    ...
                    b.Property<DateTime?>("CO_R1")
                        .HasColumnType("timestamp with time zone");

                    b.Property<DateTime?>("CO_R2")
                        .HasColumnType("timestamp with time zone");

                    b.Property<DateTime?>("CO_R3")
                        .HasColumnType("timestamp with time zone");
                    ...
                    b.Property<DateTime?>("MO_R1")
                        .HasColumnType("timestamp with time zone");

                    b.Property<DateTime?>("MO_R2")
                        .HasColumnType("timestamp with time zone");
                    ...
                    b.Property<DateTime?>("PP_R1")
                        .HasColumnType("timestamp with time zone");

                    b.Property<DateTime?>("PP_R2")
                        .HasColumnType("timestamp with time zone");

                    b.Property<DateTime?>("PP_R3")
                        .HasColumnType("timestamp with time zone");
            ...
            modelBuilder.Entity("EAMS_ACore.Models.BLOModels.BLOBoothMaster", b =>
                {
                    b.HasOne("EAMS_ACore.Models.BLOModels.BLOMaster", "BLOMaster")
                        .WithMany("BLOBoothMasters")
                        .HasForeignKey("BLOMasterId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("BLOMaster");
                });
