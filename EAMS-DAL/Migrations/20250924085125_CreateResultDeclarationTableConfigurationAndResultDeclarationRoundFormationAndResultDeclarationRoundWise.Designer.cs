...
namespace EAMS_DAL.Migrations
{
    ...
    [Migration("20250924085125_CreateResultDeclarationTableConfigurationAndResultDeclarationRoundFormationAndResultDeclarationRoundWise")]
    partial class CreateResultDeclarationTableConfigurationAndResultDeclarationRoundFormationAndResultDeclarationRoundWise
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EAMS_ACore.Models.FOPanchayatZPAndPSMapping.ZpPsFOMapping", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.Property<int>("PanchayatMappingId")
                        .HasColumnType("integer");

                    b.HasKey("Id");

                    b.ToTable("ZpPsFOMappings");
                });
            ...
            modelBuilder.Entity("EAMS_ACore.Models.PanchayatMapping", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("EAMS_ACore.Models.PublicModels.ResultDeclarationRoundFormation", b =>
                {
                    b.Property<Guid>("RDRoundFormationId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<Guid>("RDTableConfigId")
                        .HasColumnType("uuid");
                    ...
                    b.HasKey("RDRoundFormationId");

                    b.HasIndex("RDTableConfigId");

                    b.ToTable("ResultDeclarationRoundFormations");
                });

            modelBuilder.Entity("EAMS_ACore.Models.PublicModels.ResultDeclarationRoundWise", b =>
                {
                    b.Property<Guid>("RDRoundWiseId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<int?>("TotalCommulativeVotes")
                        .HasColumnType("integer");
                    ...
                    b.HasKey("RDRoundWiseId");

                    b.HasIndex("RDRoundFormationId");

                    b.HasIndex("RDTableConfigId");

                    b.ToTable("ResultDeclarationRoundWises");
                });

            modelBuilder.Entity("EAMS_ACore.Models.PublicModels.ResultDeclarationTableConfiguration", b =>
                {
                    b.Property<Guid>("RDTableConfigId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasKey("RDTableConfigId");

                    b.ToTable("ResultDeclarationTableConfigurations");
                });
            ...
            modelBuilder.Entity("EAMS_ACore.Models.PublicModels.ResultDeclarationRoundFormation", b =>
                {
                    b.HasOne("EAMS_ACore.Models.PublicModels.ResultDeclarationTableConfiguration", "ResultDeclarationTableConfigurations")
                        .WithMany("ResultDeclarationRoundFormations")
                        .HasForeignKey("RDTableConfigId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("ResultDeclarationTableConfigurations");
                });

            modelBuilder.Entity("EAMS_ACore.Models.PublicModels.ResultDeclarationRoundWise", b =>
                {
                    b.HasOne("EAMS_ACore.Models.PublicModels.ResultDeclarationRoundFormation", "ResultDeclarationRoundFormations")
                        .WithMany("ResultDeclarationRoundWises")
                        .HasForeignKey("RDRoundFormationId");

                    b.HasOne("EAMS_ACore.Models.PublicModels.ResultDeclarationTableConfiguration", "ResultDeclarationTableConfigurations")
                        .WithMany("ResultDeclarationRoundWises")
                        .HasForeignKey("RDTableConfigId");

                    b.Navigation("ResultDeclarationRoundFormations");
            ...
            modelBuilder.Entity("EAMS_ACore.Models.PublicModels.ResultDeclarationRoundFormation", b =>
                {
                    b.Navigation("ResultDeclarationRoundWises");
                });
