...
namespace EAMS_DAL.Migrations
{
    ...
    [Migration("20240806095556_addedblockpchyt")]
    partial class addedblockpchyt
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EAMS_ACore.AuthModels.UserPSZone", b =>
                {
                    b.Property<int>("UserPSZoneId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");

                    NpgsqlPropertyBuilderExtensions.UseIdentityByDefaultColumn(b.Property<int>("UserPSZoneId"));
                    ...
                    b.HasKey("UserPSZoneId");

                    b.HasIndex("UserAssemblyId");

                    b.ToTable("UserPSZone");
                });
            ...
            modelBuilder.Entity("EAMS_ACore.BoothMaster", b =>
                {
                    ...
                    b.Property<int?>("BlockPanchayatMasterId")
                        .HasColumnType("integer");
                    ...
                    b.HasIndex("BlockPanchayatMasterId");

                    b.HasIndex("DistrictMasterId");

                    b.HasIndex("ElectionTypeMasterId");

                    b.HasIndex("PSZoneMasterId");
            ...
            modelBuilder.Entity("EAMS_ACore.Models.BlockPanchayat", b =>
                {
                    b.Property<int>("BlockPanchayatMasterId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");

                    NpgsqlPropertyBuilderExtensions.UseIdentityByDefaultColumn(b.Property<int>("BlockPanchayatMasterId"));

                    b.Property<int>("AssemblyMasterId")
                        .HasColumnType("integer");

                    b.Property<int>("BlockPanchayatBooths")
                        .HasColumnType("integer");

                    b.Property<string>("BlockPanchayatCategory")
                        .HasColumnType("text");

                    b.Property<int>("BlockPanchayatCode")
                        .HasColumnType("integer");

                    b.Property<DateTime?>("BlockPanchayatCreatedAt")
                        .HasColumnType("timestamp with time zone");

                    b.Property<DateTime?>("BlockPanchayatDeletedAt")
                        .HasColumnType("timestamp with time zone");

                    b.Property<string>("BlockPanchayatName")
                        .IsRequired()
                        .HasColumnType("text");

                    b.Property<bool>("BlockPanchayatStatus")
                        .HasColumnType("boolean");

                    b.Property<string>("BlockPanchayatType")
                        .HasColumnType("text");

                    b.Property<DateTime?>("BlockPanchayatUpdatedAt")
                        .HasColumnType("timestamp with time zone");
                    ...
                    b.HasKey("BlockPanchayatMasterId");
            ...
            modelBuilder.Entity("EAMS_ACore.Models.PSZone", b =>
                {
                    b.Property<int>("PSZoneMasterId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");

                    NpgsqlPropertyBuilderExtensions.UseIdentityByDefaultColumn(b.Property<int>("PSZoneMasterId"));
                    ...
                    b.Property<int>("PSZoneBooths")
                        .HasColumnType("integer");

                    b.Property<string>("PSZoneCategory")
                        .HasColumnType("text");

                    b.Property<int>("PSZoneCode")
                        .HasColumnType("integer");

                    b.Property<DateTime?>("PSZoneCreatedAt")
                        .HasColumnType("timestamp with time zone");

                    b.Property<DateTime?>("PSZoneDeletedAt")
                        .HasColumnType("timestamp with time zone");

                    b.Property<string>("PSZoneName")
                        .IsRequired()
                        .HasColumnType("text");

                    b.Property<bool>("PSZoneStatus")
                        .HasColumnType("boolean");

                    b.Property<string>("PSZoneType")
                        .HasColumnType("text");

                    b.Property<DateTime?>("PSZoneUpdatedAt")
                        .HasColumnType("timestamp with time zone");

                    b.Property<int>("StateMasterId")
                        .HasColumnType("integer");

                    b.HasKey("PSZoneMasterId");
            ...
            modelBuilder.Entity("EAMS_ACore.Models.SarpanchWards", b =>
                {
                    b.Property<int>("SarpanchWardsMasterId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");

                    NpgsqlPropertyBuilderExtensions.UseIdentityByDefaultColumn(b.Property<int>("SarpanchWardsMasterId"));
                    ...
                    b.Property<string>("SarpanchWardsCategory")
                        .HasColumnType("text");

                    b.Property<int>("SarpanchWardsCode")
                        .HasColumnType("integer");

                    b.Property<DateTime?>("SarpanchWardsCreatedAt")
                        .HasColumnType("timestamp with time zone");

                    b.Property<DateTime?>("SarpanchWardsDeletedAt")
                        .HasColumnType("timestamp with time zone");

                    b.Property<string>("SarpanchWardsName")
                        .IsRequired()
                        .HasColumnType("text");

                    b.Property<bool>("SarpanchWardsStatus")
                        .HasColumnType("boolean");

                    b.Property<string>("SarpanchWardsType")
                        .HasColumnType("text");

                    b.Property<DateTime?>("SarpanchWardsUpdatedAt")
                        .HasColumnType("timestamp with time zone");

                    b.Property<int>("StateMasterId")
                        .HasColumnType("integer");

                    b.HasKey("SarpanchWardsMasterId");

                    b.HasIndex("AssemblyMasterId");

                    b.HasIndex("BoothMasterId");
            ...
            modelBuilder.Entity("EAMS_ACore.AuthModels.UserPSZone", b =>
                {
                    b.HasOne("EAMS_ACore.AuthModels.UserAssembly", "UserAssembly")
                        .WithMany("UserPSZone")
                        .HasForeignKey("UserAssemblyId");
            ...
            modelBuilder.Entity("EAMS_ACore.BoothMaster", b =>
                {
                    ...
                    b.HasOne("EAMS_ACore.Models.BlockPanchayat", "BlockPanchayat")
                        .WithMany("BoothMaster")
                        .HasForeignKey("BlockPanchayatMasterId");
            ...
            modelBuilder.Entity("EAMS_ACore.Models.SarpanchWards", b =>
                {
                    ...
                    b.HasOne("EAMS_ACore.BoothMaster", "BoothMaster")
                        .WithMany("SarpanchWards")
                        .HasForeignKey("BoothMasterId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
