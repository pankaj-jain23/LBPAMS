...
namespace EAMS_DAL.Migrations
{
    ...
    [Migration("20231211070930_PollDetailsAndSlotManagment")]
    partial class PollDetailsAndSlotManagment
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EAMS_ACore.Models.PollDetail", b =>
                {
                    ...
                    b.HasIndex("SlotManagementId");

                    b.ToTable("PollDetail");
                });
            ...
            modelBuilder.Entity("EAMS_ACore.Models.SlotManagement", b =>
                {
                    b.Property<int>("SlotManagementId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.Property<DateTime>("SlotCreatedTime")
                        .HasColumnType("timestamp with time zone");
            ...
            modelBuilder.Entity("EAMS_ACore.Models.PollDetail", b =>
                {
                    b.HasOne("EAMS_ACore.Models.SlotManagement", "SlotManagement")
                        .WithMany("PollDetails")
                        .HasForeignKey("SlotManagementId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("SlotManagement");
                });
