...
namespace EAMS_DAL.Migrations
{
    ...
    [Migration("20240809052906_changedallhierarchy")]
    partial class changedallhierarchy
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EAMS_ACore.Models.BlockZonePanchayat", b =>
                {
                    b.Property<int>("BlockZonePanchayatMasterId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");

                    NpgsqlPropertyBuilderExtensions.UseIdentityByDefaultColumn(b.Property<int>("BlockZonePanchayatMasterId"));

                    b.Property<int>("AssemblyMasterId")
                        .HasColumnType("integer");

                    b.Property<int>("BlockZonePanchayatBooths")
                        .HasColumnType("integer");

                    b.Property<string>("BlockZonePanchayatCategory")
                        .HasColumnType("text");

                    b.Property<int>("BlockZonePanchayatCode")
                        .HasColumnType("integer");

                    b.Property<DateTime?>("BlockZonePanchayatCreatedAt")
                        .HasColumnType("timestamp with time zone");

                    b.Property<DateTime?>("BlockZonePanchayatDeletedAt")
                        .HasColumnType("timestamp with time zone");

                    b.Property<string>("BlockZonePanchayatName")
                        .IsRequired()
                        .HasColumnType("text");

                    b.Property<bool>("BlockZonePanchayatStatus")
                        .HasColumnType("boolean");

                    b.Property<string>("BlockZonePanchayatType")
                        .HasColumnType("text");

                    b.Property<DateTime?>("BlockZonePanchayatUpdatedAt")
                        .HasColumnType("timestamp with time zone");
                    ...
                    b.HasKey("BlockZonePanchayatMasterId");
            ...
            modelBuilder.Entity("EAMS_ACore.Models.SarpanchWards", b =>
                {
                    ...
                    b.HasIndex("BlockZonePanchayatMasterId");
            ...
            modelBuilder.Entity("EAMS_ACore.BoothMaster", b =>
                {
                    ...
                    b.HasOne("EAMS_ACore.Models.BlockZonePanchayat", "BlockPanchayat")
                        .WithMany("BoothMaster")
            ...
            modelBuilder.Entity("EAMS_ACore.Models.SarpanchWards", b =>
                {
                    ...
                    b.HasOne("EAMS_ACore.Models.BlockZonePanchayat", "BlockZonePanchayat")
                        .WithMany("SarpanchWards")
                        .HasForeignKey("BlockZonePanchayatMasterId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                    ...
                    b.Navigation("BlockZonePanchayat");
